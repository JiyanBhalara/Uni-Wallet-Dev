...
export default function RewardsPage() {
  ...
  return (
    <main className="space-y-3 sm:space-y-4">
      <h1 className="text-lg sm:text-xl md:text-2xl font-semibold">Rewards</h1>
      <Card className="bg-[var(--sc-green-dark)] text-[var(--sc-cream)]">
        <CardHeader>
          <div>
            <p className="text-[0.6rem] sm:text-[0.65rem] uppercase tracking-[0.18em] text-[rgba(254,250,224,0.7)]">
              Wallet Rewards
            </p>
            <p className="text-xs sm:text-sm font-semibold">Your progress</p>
          </div>
        </CardHeader>
        <CardContent>
          <div className="flex items-end justify-between mb-3 sm:mb-4 gap-3">
            <div>
              <p className="text-[0.65rem] sm:text-[0.7rem] text-[rgba(254,250,224,0.7)]">
                Current points
              </p>
              <p className="text-2xl sm:text-3xl font-semibold">{points}</p>
            </div>
            <div className="text-right text-[0.65rem] sm:text-[0.7rem] text-[rgba(254,250,224,0.8)]">
              <p>Tier: {tier}</p>
          ...
          <p className="text-[0.65rem] sm:text-[0.7rem] text-[rgba(254,250,224,0.85)]">
