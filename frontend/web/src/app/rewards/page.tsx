  ...
  return (
    <main className="space-y-4">
      ...
      <Card className="bg-[var(--sc-green-dark)] text-[var(--sc-cream)]">
        <CardHeader>
          <div>
            <p className="text-[0.65rem] uppercase tracking-[0.18em] text-[rgba(254,250,224,0.7)]">
              Wallet Rewards
            </p>
        ...
        <CardContent>
          <div className="flex items-end justify-between mb-4">
            <div>
              <p className="text-[0.7rem] text-[rgba(254,250,224,0.7)]">
                Current points
              </p>
              <p className="text-3xl font-semibold">{points}</p>
            </div>
            <div className="text-right text-[0.7rem] text-[rgba(254,250,224,0.8)]">
              <p>Tier: {tier}</p>
              <p>Next tier at {nextTierAt} pts</p>
            </div>
          </div>
          ...
          <p className="text-[0.7rem] text-[rgba(254,250,224,0.85)]">
